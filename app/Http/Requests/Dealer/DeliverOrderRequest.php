...
final class DeliverOrderRequest extends FormRequest
{
    ...
    {
        // Yetkazib beruvchi va owner — Policy `deliver` ability orqali
        // boshqariladi (controller'da). Ruxsat formasi/validation bosqichi
        // emas, balki business logic darajasida tekshiriladi.
